...
int main() {
    ...
    Shader ourShader(
        "shaders/vert.vs",
        "shaders/frag.fs");  // you can name your shader files however you like
    ...
    unsigned char* data1 =
        stbi_load("images/tema.jpg", &width, &height, &nrChannels, 0);
    if (data1) {
    ...
    unsigned char* data2 =
        stbi_load("images/vrot.png", &width, &height, &nrChannels, 0);
    if (data2) {
